...
CoreDrawEdgeContext::CoreDrawEdgeContext(ID3D12Device* device) : BaseDrawContext(device)
{
    ...
    mShader.AddVertexShader("Core\\Shader\\EdgeLightVertexShader.hlsl");
    mShader.AddPixelShader("Core\\Shader\\EdgeLightPixelShader.hlsl");
...
void CoreDrawEdgeContext::InitPSO()
{
