...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
    ...
    { 
        ptr += offsetInDescriptors * ((SIZE_T) descriptorIncrementSize);
        return *this;
    }
    ...
    {
        handle.ptr = base.ptr + offsetInDescriptors * ((SIZE_T)descriptorIncrementSize);
    }
};
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE
{
    ...
    { 
        ptr += static_cast<UINT64>(offsetInDescriptors) * descriptorIncrementSize;
        return *this;
    }
    ...
    {
        handle.ptr = base.ptr + static_cast<UINT64>(offsetInDescriptors) * descriptorIncrementSize;
    }
};
